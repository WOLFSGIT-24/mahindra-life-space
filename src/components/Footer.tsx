...
export default function Footer({ onOpenPrivacy, onOpenTerms }: FooterProps = {}) {
  ...
  return (
    <footer className="w-full bg-slate-100/90 text-slate-900 border-t border-slate-200 py-10 sm:py-16 font-body text-xs relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10 space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-3 sm:space-y-4">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-slate-900 font-bold text-sm sm:text-base uppercase tracking-wider font-display">
                Lifespaces
              </span>
            </div>
            ...
            <div className="space-y-2 text-xs text-slate-700 pt-1 sm:pt-2">
              <p className="flex items-start gap-2">
                <MapPin className="h-4 w-4 text-[#c8102e] shrink-0 mt-0.5" />
                <span>
                  <strong className="text-slate-900">Sales Office:</strong> The Canopy, 1st Floor, Block A, Unit No. 2, Mahindra World City, Chengalpattu 603004.
                </span>
              </p>
              <p className="flex items-start gap-2">
                <Building2 className="h-4 w-4 text-[#c8102e] shrink-0 mt-0.5" />
                <span>
                  <strong className="text-slate-900">Registered Office:</strong> Admin Block, Central Avenue, Mahindra World City, Chengalpattu, Tamil Nadu 603004.
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-2.5 sm:space-y-3">
            ...
            <div className="space-y-2.5 sm:space-y-3 text-xs text-slate-900">
              <div className="p-3 bg-white rounded-lg border border-slate-200 shadow-sm">
                <span className="text-slate-900 font-bold block">{av.name}</span>
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200 shadow-sm">
                <span className="text-slate-900 font-bold block">{lw.name}</span>
                <span className="text-[11px] text-slate-700 block mt-0.5">
          ...
          <div className="lg:col-span-3 space-y-3 sm:space-y-4">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <a
                ...
                className="flex items-center gap-2 text-sm font-bold text-slate-900 hover:text-[#c8102e] transition-colors"
              >
        ...
        <div className="space-y-3 sm:space-y-4 text-[11px] text-slate-600 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-4 border-t border-slate-200 text-[11px] text-slate-600">
            <div>
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="hover:text-[#c8102e] underline cursor-pointer text-slate-700 font-medium"
              >
                Privacy Policy
              </button>
              <span>|</span>
