      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 space-y-2">
          ...
          <h2 className="font-display text-2xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight leading-tight">
            ...
            <span className="text-slate-400 font-normal">Wellness & Community</span>
          </h2>
              ...
              <div>
                ...
                <div className="p-5 space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    {item.tag && (
                      <span className="px-2.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider bg-slate-800 text-slate-300">
                        {item.tag}
                      </span>
                    )}
                  </div>
